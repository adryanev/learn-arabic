...
<div class="materi-index box box-primary">
    ...
    <div class="box-body table-responsive">
        ...
        <table class="table table-hover table-bordered dt-responsive nowrap" id="tabelMateri" cellspacing="0"
               width="100%">
            <thead>
            <tr>
                <th>Id Materi</th>
            ...
            foreach ($dataProvider as $data) {
                echo "<tr>";
                echo "<td><a href='/learn-arabic/web/materi-detail/detail?idMateri=$data->idMateri'>$data->idMateri</a></td>";
                echo "<td><a href='/learn-arabic/web/materi-detail/detail?idMateri=$data->idMateri'>$data->namaMateri</a></td>";
                echo "<td><a href='/learn-arabic/web/materi-detail/detail?idMateri=$data->idMateri'>$data->idKategori</a></td>";
                echo "<td>
