...
class Alert extends Widget
{
    ...
    public $alertTypes = [
        'error' => [
            'class' => 'alert-danger',
            'icon' => '<i class="material_icons">error_outline</i>',
        ],
        'danger' => [
            'class' => 'alert-danger',
            'icon' => '<i class="material_icons">error_outline</i>',
        ...
        'success' => [
            'class' => 'alert-success',
            'icon' => '<i class="material_icons">check</i>',
        ],
        'info' => [
            'class' => 'alert-info',
            'icon' => '<i class="material_icons">info_outline</i>',
        ],
        'warning' => [
            'class' => 'alert-warning',
            'icon' => '<i class="material_icons">warning</i>',
        ],
    ];
